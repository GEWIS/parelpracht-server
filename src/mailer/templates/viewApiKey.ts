...
export const viewApiKey = (user: User, apiRevokeLink: string): Mail.Options => ({
  subject: 'Your API key was requested - ParelPracht',
  to: user.email,
  from: process.env.MAIL_FROM,
  html: `
    <p>Dear ${user.firstName}, <br/><br/>
      The existing API key for your account was requested. If you did not request this key, please revoke the key <a href=${apiRevokeLink}>here</a>.<br/><br/>
