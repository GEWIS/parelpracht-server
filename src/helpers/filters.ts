...
export const cartesian = <T>(...arr: FindOptionsWhere<T>[][]): FindOptionsWhere<T>[] =>
...
export function addQueryWhereClause<T extends BaseEnt>(
  params: ListParams,
...
export function addQueryBuilderSearch(
