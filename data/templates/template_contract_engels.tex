...
Undersigned, \COMPANYcontact
on behalf of \GEWISRecipient, and %{contractant1}
 and %{contractant2}
 on behalf of study association GEWIS, henceforth be known as GEWIS, hereby declare to have agreed on the following:
 \begin{itemize}
 	%{producten}
 \end{itemize}
...
\section{Attachments}
\subsection{Delivery specifications}
\begin{itemize}
