...
\setType{Invoice}           % (optional) Set the Type which is printed above the address - e.g. "Confidential"
...
Dear %{ontvanger}
,\\[2\baselineskip]
Following \GEWISoccasion{}, we hereby send you the invoice. Please transfer the agreed amount within fifteen workdays to IBAN NL22 ABNA 0528 1959 13 in the name of GEWIS, with mentioning ``\GEWISmyreference''.\\[\baselineskip]
