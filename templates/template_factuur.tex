...
\newcommand{\GEWISoccasion}{%{occasion}
}
...
Geachte %{ontvanger}
,\\[2\baselineskip]
Naar aanleiding van \GEWISoccasion\ sturen we u hierbij deze factuur. Gelieve het verschuldigde bedrag binnen vijftien werkdagen over te maken naar IBAN NL22 ABNA 0528 1959 13 ten name van GEWIS te Eindhoven, onder vermelding van ``\GEWISmyreference''.\\[\baselineskip]
